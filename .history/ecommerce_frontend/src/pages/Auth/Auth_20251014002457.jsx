...
import { API_BASE_URL, PRIMARY_COLOR } from '../../utils/config';
import {
    Card,
    CardContent,
    TextField,
...
const AuthForm = ({ type, setPage, setMessage }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const url = isLogin
            ...
            : `${API_BASE_URL}/users/register/`; // Registration URL (Assuming users app handles registration at /register/)
...
// Note: parseJwt is intentionally left undefined here as it is only needed in the AuthContext.
// We only export the necessary component and rely on the context for functionality.
