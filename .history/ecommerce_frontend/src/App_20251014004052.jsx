...
const ROUTES = {
    ...
    'register': { component: AuthForm, requiresAuth: false, props: { type: 'register' } },
...
const Router = ({ page, setPage, handleSetMessage }) => {
    ...
    if (route.requiresAuth && !isAuthenticated) {
        ...
        return <AuthForm type="login" setPage={setPage} setMessage={handleSetMessage} />;
    }
